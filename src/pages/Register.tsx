...
import { z } from "zod"
import { Eye, EyeOff, Sprout, Mail, Lock, ArrowRight, User } from "lucide-react"
            ...
            <div className="w-full max-w-[420px] space-y-8">
                ...
                <div className="flex flex-col items-center space-y-4 text-center">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-base text-slate-500 font-medium">Crie sua conta 🌱</p>
                    </div>
                </div>
                    ...
                    <CardContent className="p-8 sm:p-10">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="fullName" className="text-[10px] uppercase text-slate-400 font-bold tracking-widest pl-4">Nome Completo</Label>
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        {...register("fullName")}
                                        className={`rounded-full bg-slate-50 border-none pl-12 h-12 text-slate-600 placeholder:text-slate-300 focus-visible:ring-2 focus-visible:ring-[#00C980]/20 focus-visible:ring-offset-0 transition-all ${errors.fullName ? "ring-2 ring-red-100 bg-red-50 text-red-600" : ""}`}
                                    />
                                </div>
                                {errors.fullName && (
                                    <p className="text-xs text-red-500 pl-4 font-medium">{errors.fullName.message}</p>
                                )}
                            </div>
                ...
                <div className="text-center space-y-6">
                    <p className="text-sm text-slate-500 font-medium">
                        Já tem uma conta?{" "}
                        <a href="/login" className="font-bold text-[#00C980] hover:text-[#00b372] hover:underline transition-colors">
                            Faça login
                        </a>
                    </p>
